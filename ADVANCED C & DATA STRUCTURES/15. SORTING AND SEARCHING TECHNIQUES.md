...
It first builds a Max Heap and repeatedly removes the largest element from the heap to get the sorted array.
## What is a Heap?
...
Largest element always stays at the root of the heap.
...
## Key Point
Linear Search scans elements sequentially from beginning to end until the target element is found.
...
6. Repeat until element is found or search space becomes empty.
## Example
Sorted Array:
```
...
* Sorting may require extra time
## Real-Time Uses
* Database indexing
* Search engines
...
## Key Point
Binary Search repeatedly divides the array into halves, making it much faster than Linear Search for large sorted datasets.
